...
- Task #3 Record notes of 1st group meeting's discussion
   ...
   Tests:
   To mark down the information of 1st meeting.
...
- Task #5 Record notes of 2nd group meeting's discussion.
  ...
  Requirements:
   ...
   Tests:
   To mark down the information of 2nd meeting.
  ...
  - Task #7 Record notes of 3rd group meeting's discussion
   ...
   Tests:
   To mark down the information of 3rd meeting.
  ...
  - Task #9 Setting the rules for managing tasks using the issue system
   ...
   Tests:
   To set the rules for the formatting of tasks and issues.
  ...
  - Task #10 Defining the object of our topic
   ...
   Tests:
   To figure out what our topicis mainly doing.
